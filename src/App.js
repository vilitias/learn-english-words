...
function App() {
  ...
  useEffect(() => {
    const savedLearnedWordsString = localStorage.getItem("learnedWords");
    const savedLearnedWords = JSON.parse(savedLearnedWordsString);
    // console.log(savedLearnedWordsString);
